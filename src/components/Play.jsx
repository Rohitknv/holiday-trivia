...
const Play = ({ teams, setTeams }) => {
    ...
    const confirmRestartGame = () => {
        // Reset scores but preserve team data
                ...
                <Fade in={true}>
                    <Box sx={{ textAlign: 'center', mb: 6 }}>
                        <Typography
                            ...
                            sx={{
                                mb: 2,
                                animation: `${celebrationBounce} 2s ease infinite`,
                                color: winner.color
                            }}
                        >
                            🎉 Game Complete! 🎉
                        ...
                        <Typography variant="h4" sx={{ mb: 4 }}>
                            Congratulations {winner.emoji} <span style={{ color: winner.color }}>{winner.name}</span>!
                        </Typography>
                    </Box>
                </Fade>
